...
def fire_module(x, fire_id, squeeze=16, expand1=64,expand3=64):
...
def SqueezeNet(input_shape=(32,32,3), classes=10):
    ...
    x = fire_module(x, fire_id=2, squeeze=16, expand1=64, expand3=64)
    x = fire_module(x, fire_id=3, squeeze=32, expand1=128, expand3=128)
    #x = fire_module(x, fire_id=4, squeeze=32, expand=128)
    x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool3')(x)
    #x = Dropout(0.2)(x)

    x = fire_module(x, fire_id=4, squeeze=32, expand1=128, expand3=128)
    x = fire_module(x, fire_id=5, squeeze=64, expand1=256, expand3=256)
    #x = fire_module(x, fire_id=7, squeeze=48, expand=192)
    #x = fire_module(x, fire_id=8, squeeze=64, expand=256)
    x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool5')(x)
    #x = Dropout(0.2)(x)

    x = fire_module(x, fire_id=6, squeeze=64, expand1=256, expand3=256)
